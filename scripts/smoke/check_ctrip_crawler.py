...
CtripReviewCrawlerTool = _bootstrap.import_tools_module("crawlers.ctrip_crawler_tool").CtripReviewCrawlerTool
...
async def main() -> int:
    ...
    print(f"websearch={settings.ctrip_websearch_signal_enabled and settings.mcp_search_enabled}")
