            ...
            user_payload.update(
                {
                    ...
                    "capability_summary": prompt_context.get("capability_summary"),
                    "candidate_tool_plan": prompt_context.get("candidate_tool_plan"),
                }
            )
            if whitelist is not None:
                user_payload["tool_whitelist"] = whitelist.model_dump()
