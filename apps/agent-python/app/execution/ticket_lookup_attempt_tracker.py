...
from app.execution.retrieval_attempt_ledger import (
    get_ledger,
...
from app.planning.ticket_lookup_helpers import has_ticket_url_inputs
...
def _fact_lookup_policy():
    return importlib.import_module("app.orchestration.fact_lookup_policy")
