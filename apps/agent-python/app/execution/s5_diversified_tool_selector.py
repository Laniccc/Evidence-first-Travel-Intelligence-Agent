...
from app.integrations.mcp.tool_arguments import nearby_coordinate_patch
from app.planning.intent_strategy_registry import resolve_intent_strategy
from app.execution.s5_tool_attempt_ledger import (
    Phase,
    S5ToolAttemptLedger,
    ToolAttemptRecord,
    get_ledger,
...
from app.planning.s5_poi_anchor_policy import poi_anchor_satisfied
...
def _information_need_aliases():
    return importlib.import_module("app.understanding.information_need_aliases")
    ...
    def validate_tool_args(self, tool_name: str, *, claim_type: str | None = None) -> bool:
        ...
        if tool == "baidu_route_mcp":
            ...
            if goal and goal.start_location and frame and frame.entities and frame.entities.places:
                return True
            from app.integrations.mcp.tool_arguments import _route_endpoints_from_text
