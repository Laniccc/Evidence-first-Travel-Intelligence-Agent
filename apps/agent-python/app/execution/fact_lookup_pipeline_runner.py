...
def is_geographic_fact_need(need: str) -> bool:
    return _module("app.orchestration.fact_lookup_anchor_policy").is_geographic_fact_need(need)
...
def count_actionable_fact_claims(evidence: list, need: str) -> int:
    return _module("app.orchestration.fact_lookup_policy").count_actionable_fact_claims(evidence, need)


def has_authoritative_geo_evidence(evidence: list, need: str) -> bool:
    return _module("app.orchestration.fact_lookup_policy").has_authoritative_geo_evidence(evidence, need)


def has_official_fact_evidence(evidence: list, need: str) -> bool:
    return _module("app.orchestration.fact_lookup_policy").has_official_fact_evidence(evidence, need)


def pipeline_search_queries(state: Any, need: str) -> list[str]:
    return _module("app.orchestration.fact_lookup_policy").pipeline_search_queries(state, need)
