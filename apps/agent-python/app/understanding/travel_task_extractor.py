...
from app.context import ConversationMemory, UserProfile

from .travel_task import PlaceContext, TravelTask, TravelTaskType
from .user_query import IntentType, UserContext, UserGoal
...
def infer_all_nearby_needs_from_text(text: str) -> list[str]:
    return importlib.import_module(
        "app.understanding.information_need_aliases"
    ).infer_all_nearby_needs_from_text(text)
