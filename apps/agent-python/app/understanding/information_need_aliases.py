...
from app.understanding.lookup_need_aliases import resolve_lookup_need

_nearby_registry = importlib.import_module("app.evidence.nearby_category_registry")
CANONICAL_NEARBY_NEEDS = _nearby_registry.CANONICAL_NEARBY_NEEDS
GENERIC_NEARBY_NEEDS = _nearby_registry.GENERIC_NEARBY_NEEDS
NEED_ALIASES = _nearby_registry.NEED_ALIASES
infer_all_nearby_needs_from_text = _nearby_registry.infer_all_nearby_needs_from_text
infer_nearby_need_from_text = _nearby_registry.infer_nearby_need_from_text
normalize_canonical_need = _nearby_registry.normalize_canonical_need
