...
from app.evidence.claim_family_registry import (
    claim_family_for_type,
    extraction_schema_for,
    preferred_source_families_for,
)
from app.understanding.lookup_need_aliases import infer_lookup_needs_from_text, is_elevation_lookup_text
from app.planning.ticket_product_policy import extract_ticket_product_context
from app.understanding.intent_profile import IntentProfile, PrimaryIntent
from app.planning.lookup_claim import LookupClaim
