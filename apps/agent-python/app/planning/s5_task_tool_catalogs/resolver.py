...
from app.planning.s5_task_tool_catalogs.live_status import LIVE_STATUS_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.minimal_probe import MINIMAL_PROBE_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.mixed_advisory import MIXED_ADVISORY_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.poi_recommendation import POI_RECOMMENDATION_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.review_first import REVIEW_FIRST_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.route_first import ROUTE_FIRST_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.shared import SHARED_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.strict_fact_lookup import STRICT_FACT_LOOKUP_TOOL_CATALOG
from app.planning.s5_task_tool_catalogs.ticket_price_lookup import TICKET_PRICE_LOOKUP_TOOL_CATALOG
...
def resolve_s5_task_class(state: Any) -> str:
    S5DiversifiedToolSelector = importlib.import_module(
