...
from app.understanding.information_need_aliases import is_nearby_need, normalize_need

TravelAgentState = Any


def _location_key(candidate: dict) -> tuple:
    return importlib.import_module("app.orchestration.place_disambiguation")._location_key(
        candidate
    )
