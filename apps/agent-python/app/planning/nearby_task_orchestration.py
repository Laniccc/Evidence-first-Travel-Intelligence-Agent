...
from app.evidence.nearby_enrichment_policy import (
    nearby_reputation_satisfied,
    requires_nearby_reputation_signal,
)
from app.evidence.poi_anchor_extraction import candidates_are_ambiguous
from app.planning.nearby_anchor_policy import anchor_place_name, same_scenic_area_sub_poi_ambiguity
from app.evidence.nearby_recommendation_policy import actionable_claim_types_for_need
...
def extract_place_candidates(evidence: list[Evidence]) -> list[dict]:
    ...
    ).extract_place_candidates(evidence)
