...
def multi_value_signal_for_need(state: Any, information_need: str) -> bool:
...
def contradiction_needs_for_state(state: Any) -> list[str]:
...
def any_contradiction_signal(state: Any) -> tuple[str, bool]:
