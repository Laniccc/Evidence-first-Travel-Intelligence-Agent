...
from app.evidence.claim_policy_registry import ClaimPolicyView

_intent_strategy = importlib.import_module("app.planning.intent_strategy_registry")
IntentStrategy = _intent_strategy.IntentStrategy
S7PolicyName = _intent_strategy.S7PolicyName
