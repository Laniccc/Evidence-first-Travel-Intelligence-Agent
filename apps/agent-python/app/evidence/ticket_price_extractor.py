...
from app.evidence.claim_family_registry import claim_family_for_type
from app.evidence.claim_facts import TicketPriceFact
...
from app.evidence.ticket_price_audit import is_platform_addon_for_claim

LookupClaim = Any


def strength_for_evidence(evidence: Evidence, family: str) -> str:
    return importlib.import_module("app.evidence.evidence_ladder").strength_for_evidence(
        evidence, family
    )
