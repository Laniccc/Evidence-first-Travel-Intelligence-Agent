...
from app.evidence.evidence_policy import CLAIM_POLICIES, ClaimPolicy, EvidencePolicy
...
def resolve_policy(claim: ClaimRequirement) -> ClaimPolicyView:
    ...
    nearby_policy = importlib.import_module("app.evidence.nearby_recommendation_policy")
    claim_aliases_for_need = nearby_policy.claim_aliases_for_need
    is_nearby_information_need = nearby_policy.is_nearby_information_need
