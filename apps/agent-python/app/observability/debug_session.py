...
_DEBUG_MD = Path(__file__).resolve().parents[2] / "debug_last_session.md"
...
def write_agent_debug_session(query: str, result: TravelQueryResponse) -> Path:
    return write_debug_session_md(query, result)
