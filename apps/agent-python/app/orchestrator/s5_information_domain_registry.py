...
_NEARBY_BINDINGS: list[S5DomainToolBinding] = [
    ...
    _b(D.NEARBY_RECOMMENDATION, P.BAIDU_LBS_PROVIDER, "baidu_reverse_geocode_mcp", R.PRIMARY, _NEARBY_CLAIMS),
    _b(D.NEARBY_RECOMMENDATION, P.BAIDU_LBS_PROVIDER, "baidu_route_mcp", R.PRIMARY, _NEARBY_CLAIMS),
    _b(D.NEARBY_RECOMMENDATION, P.CRAWLER_PROVIDER, "nearby_food_mcp", R.CANDIDATE, _NEARBY_CLAIMS),
