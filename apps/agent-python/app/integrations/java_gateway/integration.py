...
from app.integrations.java_gateway.config import get_tool_gateway_config
from app.integrations.java_gateway.converters import evidence_list_from_gateway, tool_trace_from_gateway
from app.integrations.java_gateway.java_client import JavaToolGatewayClient, JavaToolGatewayUnavailable
...
async def try_java_tool_gateway(
    ...
    is_mcp_policy_tool = _module("app.tools.tool_name_resolver").is_mcp_policy_tool
...
def _gateway_action_result(
    ...
    ActionResult = _module("app.execution.actions").ActionResult
