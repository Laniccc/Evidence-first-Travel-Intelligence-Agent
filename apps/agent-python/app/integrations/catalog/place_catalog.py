...
from tools.mock import data as mock_catalog


def _place_context_class():
    return importlib.import_module("app.understanding.travel_task").PlaceContext
...
class PlaceCatalogService:
    ...
    def resolve_place_context(self, original_name: str):
        PlaceContext = _place_context_class()
