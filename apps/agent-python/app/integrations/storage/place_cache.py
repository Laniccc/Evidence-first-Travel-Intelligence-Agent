...
def _place_candidate_class():
    return importlib.import_module("app.understanding.place_candidate").PlaceCandidate
...
class PlaceCache:
    ...
    def get(self, key: str):
        ...
        if not raw:
            return None
        return _place_candidate_class().model_validate(raw)

    def set(self, key: str, candidate) -> None:
