...
async def delegate_subagent(
    ...
    *,
    ...
    if resolved == "entity_resolution_agent":
        ...
        from app.execution.entity_resolution import EntityResolutionAgent
    ...
    if resolved == "fact_lookup_agent":
        ...
        from app.execution.fact_lookup_agent import FactLookupAgent
    ...
    if resolved == "fact_search_agent":
        ...
        from app.execution.fact_search_agent import FactSearchAgent
    ...
    if resolved == "route_feasibility_agent":
        ...
        from app.execution.route_feasibility_agent import RouteFeasibilityAgent
    ...
    if resolved == "weather_context_agent":
        ...
        from app.execution.weather_context_agent import WeatherContextAgent
