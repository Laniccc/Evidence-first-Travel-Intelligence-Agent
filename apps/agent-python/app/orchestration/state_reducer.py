...
from app.evidence.evidence_brief import apply_evidence_brief
from app.evidence.evidence_brief_model import EvidenceBrief
from app.evidence.subagent_gate import filter_subagent_evidence
from app.evidence.official_candidate_bridge import (
    sync_official_candidates_to_structured as evidence_sync_official_candidates_to_structured,
)
from app.execution.actions import ActionResult, AgentAction, AgentActionType
from app.observability.trace import TraceRecorder
from app.observability.tool_trace import ToolTrace
from app.orchestration.fact_lookup_policy import is_fact_lookup_task
from app.orchestration.lookup_research_chain import mark_phase_complete, merge_chain_updates
...
from app.understanding.place_candidate import PlaceCandidate
    ...
    def _apply_subagent_result(
        ...
        if target == "query_understanding" and "query_understanding" in output:
            ...
            if evidence:
                ...
                sync_official_candidates_to_structured = evidence_sync_official_candidates_to_structured
